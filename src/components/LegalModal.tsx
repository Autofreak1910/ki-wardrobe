  ...
  const sections: Record<TabKey, { heading: string; items: { title: string; content: string }[] }> = {
    ...
    agb: {
      ...
      items: [
        ...
        { title: '5. Laufzeit und Kündigung', content: 'Das Pro-Abonnement verlängert sich automatisch um jeweils einen Monat, sofern es nicht rechtzeitig vor Ablauf des laufenden Abrechnungszeitraums gekündigt wird. Die Kündigung ist jederzeit über den Button "Jetzt kündigen" in den Profileinstellungen mit einem Klick möglich, ohne dass eine Weiterleitung zu Dritten erforderlich ist. Alternativ ist die Kündigung auch per E-Mail an support@kiwardrobe.com möglich. Bereits bezahlte Zeiträume werden bei einer Kündigung nicht anteilig zurückerstattet; der Zugang zu Pro-Funktionen bleibt bis zum Ende des bezahlten Zeitraums bestehen, danach erfolgt keine weitere Abbuchung.' },
