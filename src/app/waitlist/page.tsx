...
const content = {
  de: {
    ...
    compareRows: [
      { label: 'KI-Outfit-Vorschläge', free: '3 pro Woche', premium: '14 pro Woche' },
      { label: 'Wetter-Anpassung', free: '✓', premium: '✓' },
      { label: 'Virtual Try-On', free: '2/Monat', premium: '6/Woche' },
      { label: 'Style-DNA-Analyse', free: '✕', premium: '✓' },
      { label: 'Outfits teilen', free: '✕', premium: '✓' },
      { label: 'Streak Freeze', free: '✕', premium: '✓' },
    ],
  ...
  en: {
    ...
    comparePremium: 'Premium',
   compareRows: [
      { label: 'AI outfit suggestions', free: '3 per week', premium: '14 per week' },
      { label: 'Weather matching', free: '✓', premium: '✓' },
      { label: 'Virtual Try-On', free: '2/month', premium: '6/week' },
      { label: 'Style DNA analysis', free: '✕', premium: '✓' },
      { label: 'Share outfits', free: '✕', premium: '✓' },
      { label: 'Streak Freeze', free: '✕', premium: '✓' },
    ],
