  ...
  return (
    <div style={{ height: '100dvh', background: bg, display: 'flex', flexDirection: 'column' as const, alignItems: 'center', justifyContent: 'flex-start', fontFamily: "'Poppins', 'Inter', sans-serif", padding: '24px 24px 40px', position: 'relative', overflowY: 'auto' as const, overflowX: 'hidden' as const, overscrollBehavior: 'none' as const }}>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08, duration: 0.45, ease: [0.16, 1, 0.3, 1] }}
        style={{ width: '100%', maxWidth: '400px', background: card, border: `1px solid ${border}`, borderRadius: '24px', padding: '28px 24px', boxShadow: isDark ? '0 8px 40px rgba(0,0,0,0.4)' : `0 8px 40px ${accent}12`, position: 'relative', zIndex: 1, boxSizing: 'border-box' as const }}>
 ...
 {/* Step 2 */}
          ...
          {!pendingConfirmation && step === 3 && (
            <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.25 }}>
             ...
             <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '7px', marginBottom: '20px', maxHeight: '38vh', overflowY: 'auto' as const, WebkitOverflowScrolling: 'touch' as any, overscrollBehavior: 'contain' as const, touchAction: 'pan-y' as const }}>
                {countries.map(c => (
...
<p style={{ marginTop: '20px', fontSize: '11px', color: muted, position: 'relative', zIndex: 1 }}>
      ...
      {showLegalModal === 'agb' ? (
                <>     {[
                    ...
                    { title: '5. Laufzeit und Kündigung', content: 'Das Pro-Abonnement verlängert sich automatisch um jeweils einen Monat, sofern es nicht rechtzeitig vor Ablauf des laufenden Abrechnungszeitraums gekündigt wird. Die Kündigung ist jederzeit über den Button "Abo verwalten / kündigen" in den Profileinstellungen möglich — dieser öffnet das sichere Kundenportal unseres Zahlungsdienstleisters Stripe. Alternativ ist die Kündigung auch per E-Mail an support@kiwardrobe.com möglich. Bei ordentlicher Kündigung zum Ende des Abrechnungszeitraums erfolgt keine anteilige Rückerstattung des bereits bezahlten Zeitraums; der Zugang zu Pro-Funktionen bleibt bis zum Ende des bezahlten Zeitraums bestehen. Das Recht auf außerordentliche Kündigung aus wichtigem Grund gemäß § 314 BGB bleibt hiervon unberührt; in diesem Fall wird der noch nicht in Anspruch genommene Teil des Abrechnungszeitraums anteilig erstattet.' },
                ...
                <>
                 ...
                 { title: 'Welche Daten wir speichern', content: '• E-Mail-Adresse und Passwort (verschlüsselt)\n• Benutzername, Geburtsdatum, Land\n• Hochgeladene Kleidungsbilder\n• Selfie-/Körperfotos für die Virtual-Try-On-Funktion\n• Generierte Outfits und Avatar-Bilder\n• Standortdaten für die Wetteranzeige und tägliche Outfit-Vorschläge\n• Push-Notification-Anmeldedaten (falls aktiviert)\n• Zahlungsbezogene Daten bei Abschluss eines Pro-Abonnements (über Stripe)\n• Referral-Code und Einladungsstatistiken\n• Bevorzugte Einkaufs-Shops (optional, für personalisierte Empfehlungen)\n• Feedback-Nachrichten, Bewertungen und optional angegebene Kontakt-E-Mail\n• Nutzungsstatistiken der App' },
                    ...
                    { title: 'Drittanbieter', content: '• Supabase (Datenspeicherung, EU-Server Frankfurt)\n• OpenAI (KI-Analyse für Outfit-Vorschläge und Stilanalyse, Server in den USA)\n• Replicate (KI-Bildverarbeitung für Virtual Try-On/Avatar-Generierung und Hintergrundentfernung, Server in den USA)\n• Stripe (Zahlungsabwicklung für Pro-Abonnements)\n• Resend (Versand von Transaktions-E-Mails wie Willkommens-, Kündigungs- und Ablaufbenachrichtigungen)\n• Vercel (Hosting, inkl. Server in den USA)\n• Open-Meteo / OpenStreetMap (Wetter- und Standortdaten)\n\nBei Übermittlung an Anbieter mit Servern außerhalb der EU/des EWR (USA) stellen wir ein angemessenes Datenschutzniveau durch geeignete Garantien sicher, insbesondere durch EU-Standardvertragsklauseln (Art. 46 DSGVO) bzw. die Teilnahme der Anbieter am EU-U.S. Data Privacy Framework, soweit zutreffend.' },
                    { title: 'Deine Rechte', content: '• Auskunft über gespeicherte Daten (Art. 15 DSGVO)\n• Berichtigung falscher Daten (Art. 16 DSGVO)\n• Löschung deiner Daten (Art. 17 DSGVO)\n• Einschränkung der Verarbeitung (Art. 18 DSGVO)\n• Datenportabilität (Art. 20 DSGVO)\n• Widerspruch gegen die Verarbeitung (Art. 21 DSGVO)\n• Widerruf einer erteilten Einwilligung mit Wirkung für die Zukunft (Art. 7 Abs. 3 DSGVO)\n• Beschwerde bei einer Datenschutz-Aufsichtsbehörde, z. B. der für uns zuständigen Landesdatenschutzbehörde Bayern (Bayerisches Landesamt für Datenschutzaufsicht, www.lda.bayern.de)\n\nKontakt: support@kiwardrobe.com' },
