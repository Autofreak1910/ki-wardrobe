...
<div style={{ display: 'flex', gap: '18px', marginBottom: (selectedItem.category === 'roecke' || selectedItem.category === 'kleider') ? '18px' : '26px' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <label style={{ fontSize: '11px', fontWeight: 600, color: muted, display: 'block', marginBottom: '7px', textTransform: 'uppercase' as const, letterSpacing: '0.06em' }}>{t('wardrobe.purchasePrice')}</label>
